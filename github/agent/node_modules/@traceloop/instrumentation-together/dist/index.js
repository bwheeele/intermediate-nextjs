...
class TogetherInstrumentation extends instrumentation.InstrumentationBase {
    constructor(config = {}) {
    ...
    init() {
        const module = new instrumentation.InstrumentationNodeModuleDefinition("together-ai", [">=0.13.0"], this.patch.bind(this), this.unpatch.bind(this));
        return module;
    }
    ...
    startSpan({ type, params, }) {
        var _a, _b, _c, _d;
        const attributes = {
            [aiSemanticConventions.SpanAttributes.LLM_SYSTEM]: "TogetherAI",
            ...
            if (this._shouldSendPrompts()) {
                if (type === "chat") {
                    ...
                    (_a = params.tools) === null || _a === void 0 ? void 0 : _a.forEach((func, index) => {
                        var _a, _b, _c;
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.name`] = (_a = func.function) === null || _a === void 0 ? void 0 : _a.name;
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.description`] = (_b = func.function) === null || _b === void 0 ? void 0 : _b.description;
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.arguments`] = JSON.stringify((_c = func.function) === null || _c === void 0 ? void 0 : _c.parameters);
                    });
                    (_b = params.tools) === null || _b === void 0 ? void 0 : _b.forEach((tool, index) => {
                        if (!tool.function) {
                            return;
                        }
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.name`] = tool.function.name;
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.description`] = tool.function.description;
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.arguments`] = JSON.stringify(tool.function.parameters);
                    });
                }
                else {
    ...
    _streamingWrapPromise(_a) {
        return tslib.__asyncGenerator(this, arguments, function* _streamingWrapPromise_1({ span, type, params, promise, }) {
            ...
            if (type === "chat") {
                ...
                const stream = yield tslib.__await(promise);
                try {
                    for (var _2 = true, stream_1 = tslib.__asyncValues(stream), stream_1_1; stream_1_1 = yield tslib.__await(stream_1.next()), _b = stream_1_1.done, !_b; _2 = true) {
                        _d = stream_1_1.value;
                        _2 = false;
                        const chunk = _d;
                    ...
                    try {
                        if (!_2 && !_b && (_c = stream_1.return)) yield tslib.__await(_c.call(stream_1));
                    }
                ...
                try {
                    for (var _3 = true, _4 = tslib.__asyncValues(yield tslib.__await(promise)), _5; _5 = yield tslib.__await(_4.next()), _e = _5.done, !_e; _3 = true) {
                        _g = _5.value;
                        _3 = false;
                        const chunk = _g;
                        yield yield tslib.__await(chunk);
                    ...
                    try {
                        if (!_3 && !_e && (_f = _4.return)) yield tslib.__await(_f.call(_4));
                    }
    ...
    _endSpan({ span, type, result, }) {
        ...
        try {
            ...
            if (result.usage) {
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_TOTAL_TOKENS, (_a = result.usage) === null || _a === void 0 ? void 0 : _a.total_tokens);
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_COMPLETION_TOKENS, (_b = result.usage) === null || _b === void 0 ? void 0 : _b.completion_tokens);
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_PROMPT_TOKENS, (_c = result.usage) === null || _c === void 0 ? void 0 : _c.prompt_tokens);
            }
            if (this._shouldSendPrompts()) {
                if (type === "chat") {
                    result.choices.forEach((choice, index) => {
                        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s;
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.finish_reason`, (_a = choice.finish_reason) !== null && _a !== void 0 ? _a : "");
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.role`, (_c = (_b = choice.message) === null || _b === void 0 ? void 0 : _b.role) !== null && _c !== void 0 ? _c : "");
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.content`, (_e = (_d = choice.message) === null || _d === void 0 ? void 0 : _d.content) !== null && _e !== void 0 ? _e : "");
                        if ((_f = choice.message) === null || _f === void 0 ? void 0 : _f.function_call) {
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.function_call.name`, (_j = (_h = (_g = choice.message) === null || _g === void 0 ? void 0 : _g.function_call) === null || _h === void 0 ? void 0 : _h.name) !== null && _j !== void 0 ? _j : "");
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.function_call.arguments`, (_m = (_l = (_k = choice.message) === null || _k === void 0 ? void 0 : _k.function_call) === null || _l === void 0 ? void 0 : _l.arguments) !== null && _m !== void 0 ? _m : "");
                        }
                        else if ((_p = (_o = choice.message) === null || _o === void 0 ? void 0 : _o.tool_calls) === null || _p === void 0 ? void 0 : _p[0]) {
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.function_call.name`, (_q = choice.message.tool_calls[0].function.name) !== null && _q !== void 0 ? _q : "");
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.function_call.arguments`, (_r = choice.message.tool_calls[0].function.arguments) !== null && _r !== void 0 ? _r : "");
                        }
                        if ((_s = choice === null || choice === void 0 ? void 0 : choice.message) === null || _s === void 0 ? void 0 : _s.tool_calls) {
                            for (const [toolIndex, toolCall,] of choice.message.tool_calls.entries()) {
                                span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.tool_calls.${toolIndex}.name`, toolCall.function.name);
                                span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.tool_calls.${toolIndex}.arguments`, toolCall.function.arguments);
                            }
                        }
                    });
                }
                    ...
                    result.choices.forEach((choice, index) => {
                        var _a, _b;
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.finish_reason`, (_a = choice.finish_reason) !== null && _a !== void 0 ? _a : "");
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.role`, "assistant");
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.content`, (_b = choice.text) !== null && _b !== void 0 ? _b : "");
                    });
                }
            }
        }
...
exports.TogetherInstrumentation = TogetherInstrumentation;
