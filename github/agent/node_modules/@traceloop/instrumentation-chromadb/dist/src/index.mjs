...
class ChromaDBInstrumentation extends InstrumentationBase {
    constructor(config = {}) {
    ...
    init() {
        const module = new InstrumentationNodeModuleDefinition("chromadb", ["^1.8.1"], this.wrap.bind(this), this.unwrap.bind(this));
        return module;
    }
...
export { ChromaDBInstrumentation };
