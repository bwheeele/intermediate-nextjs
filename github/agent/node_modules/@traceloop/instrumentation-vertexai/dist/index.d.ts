...
interface VertexAIInstrumentationConfig extends InstrumentationConfig {
    /**
...
interface AIPlatformInstrumentationConfig extends InstrumentationConfig {
    /**
     * Whether to log prompts, completions and embeddings on traces.
     * @default true
     */
...
declare class AIPlatformInstrumentation extends InstrumentationBase {
...
declare class VertexAIInstrumentation extends InstrumentationBase {
...
export { AIPlatformInstrumentation, type AIPlatformInstrumentationConfig, VertexAIInstrumentation, type VertexAIInstrumentationConfig };
