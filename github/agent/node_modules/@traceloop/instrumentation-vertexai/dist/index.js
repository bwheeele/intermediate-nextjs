...
class AIPlatformInstrumentation extends instrumentation.InstrumentationBase {
    ...
    _startSpan({ params, }) {
        ...
        const attributes = {
            [aiSemanticConventions.SpanAttributes.LLM_SYSTEM]: "VertexAI",
        ...
        try {
            if (params !== undefined) {
                if (params.endpoint) {
                    ...
                    attributes[aiSemanticConventions.SpanAttributes.LLM_RESPONSE_MODEL] = model;
                }
                if (params === null || params === void 0 ? void 0 : params.parameters) {
                    ...
                    if ((_f = (_e = params === null || params === void 0 ? void 0 : params.parameters.structValue) === null || _e === void 0 ? void 0 : _e.fields) === null || _f === void 0 ? void 0 : _f.temperature.numberValue) {
                        attributes[aiSemanticConventions.SpanAttributes.LLM_REQUEST_TEMPERATURE] =
                    ...
                    if ((_k = (_j = params === null || params === void 0 ? void 0 : params.parameters.structValue) === null || _j === void 0 ? void 0 : _j.fields) === null || _k === void 0 ? void 0 : _k.topP.numberValue) {
                        attributes[aiSemanticConventions.SpanAttributes.LLM_REQUEST_TOP_P] =
                ...
                if (this._shouldSendPrompts() &&
                    ...
                    if (((_t = params.instances[0].structValue) === null || _t === void 0 ? void 0 : _t.fields) &&
                        ...
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_PROMPTS}.0.role`] =
    ...
    _endSpan({ span, result, }) {
        ...
        try {
            if (result[0].model)
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_RESPONSE_MODEL, result[0].model);
            if (result) {
                if (result[0].metadata) {
                    if (typeof ((_g = (_f = (_e = (_d = (_c = (_b = (_a = result[0].metadata) === null || _a === void 0 ? void 0 : _a.structValue) === null || _b === void 0 ? void 0 : _b.fields) === null || _c === void 0 ? void 0 : _c.tokenMetadata.structValue) === null || _d === void 0 ? void 0 : _d.fields) === null || _e === void 0 ? void 0 : _e.outputTokenCount.structValue) === null || _f === void 0 ? void 0 : _f.fields) === null || _g === void 0 ? void 0 : _g.totalTokens.numberValue) === "number")
                        span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_COMPLETION_TOKENS, (_p = (_o = (_m = (_l = (_k = (_j = (_h = result[0].metadata) === null || _h === void 0 ? void 0 : _h.structValue) === null || _j === void 0 ? void 0 : _j.fields) === null || _k === void 0 ? void 0 : _k.tokenMetadata.structValue) === null || _l === void 0 ? void 0 : _l.fields) === null || _m === void 0 ? void 0 : _m.outputTokenCount.structValue) === null || _o === void 0 ? void 0 : _o.fields) === null || _p === void 0 ? void 0 : _p.totalTokens.numberValue);
                ...
                if (this._shouldSendPrompts()) {
                    (_32 = result[0].predictions) === null || _32 === void 0 ? void 0 : _32.forEach((prediction, index) => {
                        ...
                        if (((_a = prediction.structValue) === null || _a === void 0 ? void 0 : _a.fields) &&
                            ...
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.content`, (_e = (_d = prediction.structValue) === null || _d === void 0 ? void 0 : _d.fields) === null || _e === void 0 ? void 0 : _e.content.stringValue);
                        }
                            ...
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.role`, "assistant");
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.content`, (_v = (_u = (_t = (_s = (_r = (_q = (_p = prediction.structValue) === null || _p === void 0 ? void 0 : _p.fields) === null || _q === void 0 ? void 0 : _q.candidates.listValue) === null || _r === void 0 ? void 0 : _r.values) === null || _s === void 0 ? void 0 : _s[0]) === null || _t === void 0 ? void 0 : _t.structValue) === null || _u === void 0 ? void 0 : _u.fields) === null || _v === void 0 ? void 0 : _v.content.stringValue);
                        }
                    });
                }
            }
...
class VertexAIInstrumentation extends instrumentation.InstrumentationBase {
    ...
    _startSpan({ instance, params, }) {
        ...
        try {
            attributes[aiSemanticConventions.SpanAttributes.LLM_REQUEST_MODEL] = instance["model"];
            attributes[aiSemanticConventions.SpanAttributes.LLM_RESPONSE_MODEL] = instance["model"];
            ...
            if (this._shouldSendPrompts() && "contents" in params) {
                ...
                if (instance["systemInstruction"]) {
                    attributes[`${aiSemanticConventions.SpanAttributes.LLM_PROMPTS}.${i}.role`] = "system";
                    attributes[`${aiSemanticConventions.SpanAttributes.LLM_PROMPTS}.${i}.content`] =
                        this._formatPartsData(instance["systemInstruction"].parts);
                    i++;
                }
                params.contents.forEach((content, j) => {
                    var _a;
                    attributes[`${aiSemanticConventions.SpanAttributes.LLM_PROMPTS}.${i + j}.role`] =
                        (_a = content.role) !== null && _a !== void 0 ? _a : "user";
                    attributes[`${aiSemanticConventions.SpanAttributes.LLM_PROMPTS}.${i + j}.content`] =
        ...
        return tslib.__awaiter(this, arguments, void 0, function* ({ span, result, }) {
            ...
            try {
                ...
                if ((_c = streamResponse.usageMetadata) === null || _c === void 0 ? void 0 : _c.candidatesTokenCount)
                    span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_COMPLETION_TOKENS, streamResponse.usageMetadata.candidatesTokenCount);
                if ((_d = streamResponse.usageMetadata) === null || _d === void 0 ? void 0 : _d.promptTokenCount)
                    span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_PROMPT_TOKENS, streamResponse.usageMetadata.promptTokenCount);
                if (this._shouldSendPrompts()) {
                    (_e = streamResponse.candidates) === null || _e === void 0 ? void 0 : _e.forEach((candidate, index) => {
                        var _a;
                        if (candidate.finishReason)
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.finish_reason`, candidate.finishReason);
                        if (candidate.content) {
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.role`, (_a = candidate.content.role) !== null && _a !== void 0 ? _a : "assistant");
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.content`, this._formatPartsData(candidate.content.parts));
                        }
                    });
                }
            }
