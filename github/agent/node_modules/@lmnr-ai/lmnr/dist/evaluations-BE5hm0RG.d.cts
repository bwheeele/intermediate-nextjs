 ...
 */
type SpanType = 'DEFAULT' | 'LLM' | 'EXECUTOR' | 'EVALUATOR' | 'HUMAN_EVALUATOR' | 'EVALUATION' | 'TOOL';
/**
...
//#endregion
//#region src/client/resources/index.d.ts
...
//#endregion
//#region src/client/resources/agent.d.ts
/**
...
//#endregion
//#region src/client/resources/browser-events.d.ts
...
//#endregion
//#region src/client/resources/datasets.d.ts
...
//#endregion
//#region src/client/resources/evals.d.ts
...
//#endregion
//#region src/client/resources/evaluators.d.ts
type ScoreOptions = {
  name: string;
  metadata?: Record<string, any>;
  score: number;
...
//#endregion
//#region src/client/resources/tags.d.ts
...
declare class LaminarDataset<D, T> extends EvaluationDataset<D, T> {
   ...
   */
  push(paths: string | string[], recursive?: boolean): Promise<void>;
}
//#endregion
//#region src/opentelemetry-lib/interfaces/initialize-options.interface.d.ts
/**
 ...
 */
type EvaluatorFunction<O, T, D = any> = (output: O, target?: T, data?: D, ...args: any[]) => EvaluatorFunctionReturn | Promise<EvaluatorFunctionReturn>;
...
declare class Evaluation<D, T, O> {
  ...
  run(): Promise<EvaluationRunResult>;
 ...
 */
declare function evaluate<D, T, O>({
  data,
  executor,
  evaluators,
  groupName,
...
//#endregion
export { TracingLevel as S, MaskInputOptions as _, HumanEvaluator as a, SpanType as b, EvaluationDataset as c, StringUUID as d, Dataset as f, LaminarSpanContext as g, Event as h, EvaluatorFunctionReturn as i, LaminarDataset as l, EvaluationDatapointDatasetLink as m, Evaluation as n, evaluate as o, EvaluationDatapoint as p, EvaluatorFunction as r, InitializeOptions as s, Datapoint as t, LaminarClient as u, PushDatapointsResponse as v, TraceType as x, SessionRecordingOptions as y };
//# sourceMappingURL=evaluations-BE5hm0RG.d.cts.map