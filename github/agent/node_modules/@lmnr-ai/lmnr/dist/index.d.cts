 ...
 * });
 */
declare function observe<A extends unknown[], F extends (...args: A) => ReturnType<F>>({
  name,
  sessionId,
  userId,
  traceType,
...
declare class LaminarSpanProcessor implements SpanProcessor {
  private instance;
  private readonly _spanIdToPath;
  private readonly _spanIdLists;
  /**
  ...
  onStart(span: Span$2, parentContext: Context): void;
...
//#endregion
//#region src/opentelemetry-lib/tracing/attributes.d.ts
declare const LaminarAttributes: {
...
declare class Laminar {
   ...
   * @private
   */
  private static _initializeContextFromEnv;
  /**
   ...
   */
  static patch(modules: InitializeOptions["instrumentModules"]): void;
  /**
  ...
  static getCurrentSpan(context?: Context): Span$1 | undefined;
  /**
   ...
   * }, userMessage);
   */
  static setSpanAttributes(attributes: LaminarAttributesProp): void;
  /**
  ...
  static setTraceMetadata(metadata: Record<string, any>): void;
  static setTraceSessionId(sessionId: string): void;
  static setTraceUserId(userId: string): void;
  static setSpanTags(tags: string[]): void;
  static addSpanTags(tags: string[]): void;
  /**
   ...
   */
  static getTraceId(): StringUUID | null;
...
//#endregion
//#region src/opentelemetry-lib/instrumentation/aisdk.d.ts
declare const wrapAISDK: (ai: typeof AI) => typeof AI;
//#endregion
//#region src/opentelemetry-lib/instrumentation/claude-agent-sdk/index.d.ts
/**
 ...
 */
declare const getTracerProvider: () => TracerProvider;
/**
 * Get the tracer.
 ...
 * })
 */
declare const getTracer: () => Tracer;
//#endregion
//#region src/opentelemetry-lib/tracing/instrumentations.d.ts
/**
 ...
 */
declare const initializeLaminarInstrumentations: (options?: {
  baseUrl?: string;
  apiKey?: string;
  httpPort?: number;
