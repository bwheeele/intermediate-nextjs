...
class OpenAIInstrumentation extends instrumentation.InstrumentationBase {
    ...
    init() {
        const module = new instrumentation.InstrumentationNodeModuleDefinition("openai", [">=3.1.0 <5"], this.patch.bind(this), this.unpatch.bind(this));
        return module;
    }
    ...
    startSpan({ type, params, }) {
        var _a, _b, _c, _d;
        const attributes = {
            [aiSemanticConventions.SpanAttributes.LLM_SYSTEM]: "OpenAI",
            ...
            if (this._shouldSendPrompts()) {
                if (type === "chat") {
                    ...
                    (_a = params.functions) === null || _a === void 0 ? void 0 : _a.forEach((func, index) => {
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.name`] = func.name;
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.description`] = func.description;
                        attributes[`${aiSemanticConventions.SpanAttributes.LLM_REQUEST_FUNCTIONS}.${index}.arguments`] = JSON.stringify(func.parameters);
                    });
            ...
            if (this._shouldSendPrompts()) {
                if (type === "chat") {
                    result.choices.forEach((choice, index) => {
                        var _a, _b, _c;
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.finish_reason`, choice.finish_reason);
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.role`, choice.message.role);
                        span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.content`, (_a = choice.message.content) !== null && _a !== void 0 ? _a : "");
                        if (choice.message.function_call) {
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.function_call.name`, choice.message.function_call.name);
                            span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.${index}.function_call.arguments`, choice.message.function_call.arguments);
                        }
